...
class Developer {
  ...
  const carloDev = new Developer("Jorge", "js", ["elixir", "groovy", "lisp"])
  ...
  const jorgeLaunchXDev = new LaunchXStudent("Jorge", "js", ["elixir", "groovy", "lisp"])
  console.log(jorgeLaunchXDev)
  console.log(jorgeLaunchXDev.getName) // getter de la clase padre rehusada en la clase hija